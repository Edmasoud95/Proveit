...
CREATE TABLE "new_EvalRun" (
    ...
    "snapshotConfigVersionNumber" INTEGER,
    ...
    CONSTRAINT "EvalRun_configVersionId_fkey" FOREIGN KEY ("configVersionId") REFERENCES "PocConfigVersion" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_EvalRun" ("completedAt", "configVersionId", "evalSuiteVersionId", "failedCases", "id", "passedCases", "pocConfigId", "runNumber", "snapshotConfigVersionNumber", "snapshotEndpointUrl", "snapshotJudgeModel", "snapshotJudgeProviderName", "snapshotModel", "snapshotSystemPrompt", "startedAt", "status", "totalCases") SELECT "completedAt", "configVersionId", "evalSuiteVersionId", "failedCases", "id", "passedCases", "pocConfigId", "runNumber", "snapshotConfigVersionNumber", "snapshotEndpointUrl", "snapshotJudgeModel", "snapshotJudgeProviderName", "snapshotModel", "snapshotSystemPrompt", "startedAt", "status", "totalCases" FROM "EvalRun";
DROP TABLE "EvalRun";
